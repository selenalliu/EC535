...
int main(int argc, char *argv[]) {
    ...
    // double cpu_time_used; // TEMP

    // start = clock(); // TEMPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPP
    ///////////////////////////////////////////////
...
// function for checking register number
// int checkRegNum(char *operand) {
//     static const char *lookupTable[] = {"R1", "R2", "R3", "R4", "R5", "R6", "[R1]", "[R2]", "[R3]", "[R4]", "[R5]", "[R6]", "R1,", "R2,", "R3,", "R4,", "R5,", "R6,", "[R1],", "[R2],", "[R3],", "[R4],", "[R5],", "[R6],"};
//     for (int i = 0; i < 6; i++) {
//         if (strncmp(operand, lookupTable[i], 2) == 0) {
//             return i;
//         }
//     }
//     return -1;
